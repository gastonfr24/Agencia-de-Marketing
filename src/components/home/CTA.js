...
function CTA() {
  return (
    <div className="bg-white">
      <div className="mx-auto lg:mx-20 max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
        <h2 className="text-3xl tracking-tight text-gray-900 sm:text-4xl">
          <span className="block font-gilroy-bold">¿Listo para ser parte?</span>
          <span className="block text-orange-cus font-gilroy-semibold mt-1">Cuéntanos tu idea.</span>
        </h2>
