      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="mx-auto max-w-lg">
            <h2 className="text-2xl font-bold tracking-tight text-orange-cus sm:text-3xl">Ponerse en contacto</h2>
            <p className="mt-3 text-lg leading-6 text-gray-500">
            Si tiene alguna pregunta o desea obtener más información, no dude en ponerse en contacto con nosotros.
             Llene el formulario de contacto o envíenos un correo electrónico.
            </p>
...
{/*               <div>
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  ...
                  <span className="ml-3">support@viperpy.com</span>
                </dd>
              </div>
            </dl>
